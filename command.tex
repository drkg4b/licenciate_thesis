...
\newcommand*{\msquark}{M_{\, \widetilde{q}}}
\newcommand*{\mneutralino}{M_{\, \widetilde{\chi}_{\, 0}^{\, 1}}}
...
\newcommand*{\squarkprod}{\widetilde{q} \rightarrow q + \widetilde{\chi}_1^0\, (q = u,\, d,\, c,\, s)}
